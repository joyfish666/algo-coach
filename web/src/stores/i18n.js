...
const MESSAGES = {
  zh: {
    ...
    col_lang: '语言',
    col_verdict: '结果',
    status_filter_all: '状态',
    status_todo: '未做',
    filter_favorite: '收藏',
    action_random: '随机一题',
    random_all_paid: '当前筛选结果里只有付费题，无法随机练习；调整筛选后再试',
    density_compact: '紧凑',
    density_cozy: '舒适',
    fav_add: '收藏',
    fav_remove: '取消收藏',
    ...
    nav_groups: '分组',
    groups_title: '分组',
    groups_subtitle: '自定义刷题清单，可嵌套、可分享',
    groups_create: '新建分组',
    groups_add_child: '新建子分组',
    groups_rename: '重命名',
    groups_delete: '删除',
    groups_delete_confirm: '再次点击确认删除（含全部子分组）',
    groups_move: '移动到',
    groups_move_root: '（根层级）',
    groups_move_up: '上移',
    groups_move_down: '下移',
    groups_add_problem: '添加题目',
    groups_empty: '还没有分组——创建一个，把题目按刷题顺序组织起来',
    groups_export: '导出分享码',
    groups_export_all: '导出全部',
    groups_import: '导入分享码',
    groups_import_placeholder: '粘贴 algocoach-groups:v1:… 分享码',
    groups_import_done: '已导入 {count} 个分组',
    groups_export_done: '分享码已复制到剪贴板',
    groups_export_copy_failed: '复制失败，请手动复制文本框中的分享码',
    groups_unknown_problem: '未识别',
    groups_unknown_hint: '该题不在本地题库中，可能尚未同步；同步后自动恢复',
    groups_pick_group: '选择分组',
    groups_new_group_placeholder: '新组名…',
    groups_create_add: '创建并加入',
    groups_no_group_yet: '还没有分组，先创建一个',
    groups_no_items: '空分组——点「添加题目」把题目按顺序加入',
    groups_items_count: '{count} 题',
    groups_marked_count: '{count} 重点',
    groups_mark: '标记重点',
    groups_unmark: '取消重点',
    groups_collapse: '折叠',
    groups_expand: '展开',
  ...
  en: {
    ...
    col_lang: 'Lang',
    col_verdict: 'Verdict',
    status_filter_all: 'Status',
    status_todo: 'Not tried',
    filter_favorite: 'Favorites',
    action_random: 'Random',
    random_all_paid: 'Only premium problems match this filter - adjust it and try again',
    ...
    nav_groups: 'Groups',
    groups_title: 'Groups',
    groups_subtitle: 'Custom practice plans, nestable and shareable',
    groups_create: 'New group',
    groups_add_child: 'New subgroup',
    groups_rename: 'Rename',
    groups_delete: 'Delete',
    groups_delete_confirm: 'Click again to delete (incl. subgroups)',
    groups_move: 'Move to',
    groups_move_root: '(top level)',
    groups_move_up: 'Move up',
    groups_move_down: 'Move down',
    groups_add_problem: 'Add problem',
    groups_empty: 'No groups yet - create one to organize your practice order',
    groups_export: 'Export share code',
    groups_export_all: 'Export all',
    groups_import: 'Import share code',
    groups_import_placeholder: 'Paste an algocoach-groups:v1:… share code',
    groups_import_done: 'Imported {count} groups',
    groups_export_done: 'Share code copied to clipboard',
    groups_export_copy_failed: 'Copy failed - copy the code from the box manually',
    groups_unknown_problem: 'Unknown',
    groups_unknown_hint: 'Not in the local problem cache - sync the problem list to resolve it',
    groups_pick_group: 'Pick a group',
    groups_new_group_placeholder: 'New group name…',
    groups_create_add: 'Create & add',
    groups_no_group_yet: 'No groups yet - create one first',
    groups_no_items: 'Empty group - use "Add problem" to put problems here in order',
    groups_items_count: '{count} problems',
    groups_marked_count: '{count} key',
    groups_mark: 'Mark as key',
    groups_unmark: 'Unmark',
    groups_collapse: 'Collapse',
    groups_expand: 'Expand',
  },
}
